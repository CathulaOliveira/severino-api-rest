package com.br.antbridge.severino.resource.mod_acesso.teste;
...
import com.br.antbridge.core.dao.ListaDeClasses;
import com.br.antbridge.core.rest.RestSessao;
import com.br.antbridge.severino.entity.mod_acesso.Acesso;
import com.br.antbridge.severino.entity.mod_acesso.ObjetoTeste;
...
public class TesteController {
	...
	public Boolean verificaEmail(@PathParam("email") String email) {
		if (email!=null) {
			if (email.equals("project.antbridge@gmail.com")) {
				return true;
			}
		}
		return false;
	...
	public Boolean testelistaclasses() {
		...
		try {
			ListaDeClasses deClasses = new ListaDeClasses("com.br.antbridge.severino.entity");
